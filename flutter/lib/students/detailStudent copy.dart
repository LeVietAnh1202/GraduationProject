            ...
            (Provider.of<AppStateProvider>(context, listen: false)
                ...
                ? SizedBox(
                    ...
                    child: Container(
                      ...
                      //     //   )
                      //     // : Container(),
                      //     // ? FlickVideoPlayer(flickManager: getVideo(student).then((value) => value))
                      //     ? FutureBuilder<FlickManager>(
                      //         future: getVideo(student),
                      //         builder: (context, snapshot) {
                      //           if (snapshot.connectionState ==
                      //               ConnectionState.waiting) {
                      //             // Nếu Future chưa hoàn thành, bạn có thể hiển thị một tiêu biểu hoặc chỉ đơn giản là chờ đợi
                      //             return CircularProgressIndicator(); // Ví dụ
                      //           } else if (snapshot.hasError) {
                      //             // Nếu có lỗi xảy ra trong quá trình thực thi Future
                      //             return Text('Error: ${snapshot.error}');
                      //           } else {
                      //             // Nếu Future đã hoàn thành và không có lỗi
